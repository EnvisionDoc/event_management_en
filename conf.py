...
project = u'EnOS Device Alert Management'
...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS Device Alert Management} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'EnOS Device Alert Management',
...
man_pages = [
    (master_doc, u'enosdocumentationcenter', u'EnOS Device Alert Management',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Device Alert Management',
